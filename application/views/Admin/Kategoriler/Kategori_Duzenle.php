...
<section>
    ...
    <div class="mainpanel">
        ...
        <div class="pageheader">
            <h2><i class="fa fa-qrcode"></i>Kategori Düzenleme</h2>
        ...
        <div class="contentpanel">
            <div class="row">
                <div class="col-md-6">
                    <form method="post" action="<?php echo base_url('Admin/Kategoriler/Guncelle'); ?>">
                        <div class="form-group">
                            <label class="col-sm-4 control-label textRight">Kayıt No :</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control fc-sm" name="KategoriID" required value="<?= $Category->KategoriID ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="UstAdi" class="form-control fc-sm" required>
                                    ...
                                    <?php foreach ($UstKategoriler as $Kategori){ ?>
                                        <option value="<?=$Kategori->KategoriID ?>" <?php if($Kategori->KategoriID == $Category->Ust_ID) { echo "selected"; } ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text"  class="form-control fc-sm" name="KategoriAdi" required value="<?= $Category->KategoriAdi ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label textRight">Açıklama :</label>
                            <div class="col-sm-8">
                                <textarea name="Aciklama" class="form-control fc-sm" rows="2"><?= $Category->Aciklama ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label textRight">Anahtar Kelimeler :</label>
                            <div class="col-sm-8">
                                <textarea name="Keywords" class="form-control fc-sm" rows="2"><?= $Category->Keywords ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label class="form-control fc-sm">
                                    <input type="checkbox" id="Aktif" name="Aktif" <?php if($Category->Aktif == 1) { echo "checked=checked"; } ?>" value="<?= $Category->Aktif; ?>" />Aktif
                                </label>
                            </div>
                        </div>
                        <div class="row">
