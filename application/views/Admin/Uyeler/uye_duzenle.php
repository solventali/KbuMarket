...
<section>
    ...
    <div class="mainpanel">
        ...
        <div class="pageheader">
            <h2><i class="fa fa-users"></i> Üye Düzenleme</h2>
                    ...
                    <div class="col-md-6">
                        <form method="post" action="<?php echo base_url('Admin/Uyeler/Guncelle'); ?>">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control fc-sm" name="UyeID" required value="<?= $Uye->UyeID ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label textRight">Adı Soyadı :</label>
                                <div class="col-sm-8">
                                    <input type="text"  class="form-control fc-sm" name="AdSoyad" required value="<?= $Uye->AdSoyad ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label textRight">EMail Adresi :</label>
                                <div class="col-sm-8">
                                    <input type="email" class="form-control fc-sm" name="Email" required value="<?= $Uye->Email ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="Yetki" class="form-control fc-sm" required>
                                        ...
                                        <option value="1" <?php if($Uye->Yetki == 1) { echo "selected"; } ?>>Satıcı</option>
                                        <option value="2" <?php if($Uye->Yetki == 2) { echo "selected"; } ?>>Admin</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="password"  class="form-control fc-sm" name="Sifre" required  value="<?= $Uye->Sifre ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label textRight">Telefon No :</label>
                                <div class="col-sm-8">
                                    <input type="phone"  class="form-control fc-sm" name="Telefon" id="Telefon" required value="<?= $Uye->Telefon ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control fc-sm" name="DgmTarih" id="DgmTarih"
                                           value="<?= date("d.m.Y", strtotime($Uye->DgmTarih))  ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <label class="form-control fc-sm">
                                        <input type="checkbox" id="Aktif" name="Aktif" <?php if($Uye->Aktif == 1) { echo "checked=checked"; } ?>" value="<?= $Uye->Aktif; ?>" />Aktif
                                    </label>
                                </div>
                            </div>
                            <div class="row">
