                                            ...
                                            <?php  if ($Resimler) {
                                                foreach ($Resimler as $Resim){ ?>
                                                    <div class="slide-item">
                                                        <img src="<?= base_url('Uploads/Galeri_Resim')."/".$Resim->Resim ?>" alt="resim "/>
                                                    </div>
                                                <?php }
                                            } ?>
                                        </div>
                            ...
                            <div class="row product-description">
                                <div class="col-md-12 ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control fc-sm" required name="Miktar" id="Miktar" value="1"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <form method="post" action="<?php echo base_url('Home/YorumYap'); ?>/<?=$Urun->ID;?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control fc-sm" name="Baslik" required placeholder="Başlık" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label textRight">Yorum :</label>
                                    <div class="col-sm-8">
                                        <textarea rows="4" class="form-control fc-sm" name="Yorum" placeholder="Yorum" required></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <button class="btn btn-sm btn-block btn-orange"><i class="fa fa-check"></i>&nbsp;Yorumu Gönder</button>
                                    </div>
                                </div>
